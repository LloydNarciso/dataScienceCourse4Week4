## Project for Week 4 of the John Hopkins' Exploratory Data Analysis Coursera course (Course Project 2)
...
This repository is optional, as it is not required to be created by Coursera. This was created for my own personal records.
